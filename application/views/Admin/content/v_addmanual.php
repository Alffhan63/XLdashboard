...
<div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Manual Campaign</li>
        </ol>
      </section>
          ...
          <div class="col-md-7">
            <div class="box">
              <div class="box-header" style="background: #337ab7; border-radius: 5px;">
                <h3 class="box-title" style="color:white; padding: 3px;">Manual Create Campaign</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form class="form-horizontal" style="padding-top:10px;">
                ...
                <div class="form-group" name="">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input class="btn btn-info" type="button" id="clickme" value="Upload File" />
